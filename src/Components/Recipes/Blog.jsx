    ...
    <div>
      ...
      <div className={styles.container_content}>
        <div className={styles.para_content}>
          ...
          <p className={styles.list} onClick={Open}>
            Jump to recipes
          </p>
        </div>
      ...
      <main className={styles.main_container}>
        ...
        <div className={styles.ingredients}>
          <div className={styles.item_list}>
            ...
            <p className={styles.add_list}>
              <AiOutlinePlus /> Add to shopping list
            </p>
          </div>
      ...
      <div className={styles.left_over}>
        ...
        <div>
          ...
          <p>
            2. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
            aliquam ac tristique velit, justo, porttitor. Eget mattis a
            curabitur augue. Pellentesque urna tristique.
          </p>
          <p>
          ...
          <p>
            4. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
            aliquam ac tristique velit, justo, porttitor. Eget mattis a
            curabitur augue. Pellentesque urna tristique.
          </p>
        </div>
